"""
Django settings for chef project.
...
SECRET_KEY = '+aazk9zt3sd%ifckrxg($96-1!#4^+xqqf*8s-0jykk7cet&y&'
...
MIDDLEWARE_CLASSES = (
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware', ## Disabled because our site doesn't need it
